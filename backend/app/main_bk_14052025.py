...
def fetch_nested_national_data_toggle(input_data: DateInput3, current_user: dict = Depends(get_current_user)) -> Dict[str, Any]:
    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            native_diff_raw = try_float(row.get("Scrapped_Crtical_Absolute_Diff"))
            ...
            scheme_diff_percent_raw = try_float(row.get("%_Scrapped_Critical_Diff"))
